...
public class ExcelUtilities {
	...
	public String getCellData(String sheetName,int rownum,int colnum) throws IOException
	{
		...
		DataFormatter formatter=new DataFormatter();//data.toString();
		String data;
		try {	
			data=formatter.formatCellValue(cell);//returns the formatted value of a cell as a String regulated			
		}
		catch(Exception e) {
			data="";
		}
