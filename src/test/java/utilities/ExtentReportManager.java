...
public class ExtentReportManager implements ITestListener{
	...
	public void onTestFailure(ITestResult result) {
		...
		//to attach failed test case screenshots in report
	...
	public void onTestSkipped(ITestResult result) {
		...
		test.log(Status.SKIP,result.getName()+"Testcase skipped");//update status p/f/s
	...
	public void onFinish(ITestContext testContext) {
		...
		try {
			...
			email.setAuthenticator(new DefaultAuthenticator("knpooja899@gmail.com","password"));
			email.setSSLOnConnect(true);
			email.setFrom("knpooja899@gmail.com");//sender
			email.setSubject("Test results");
			email.setMsg("Please find the attached Report....");
			email.addTo("knpooja899@gmail.com"); //receiver
